...
from TestCases.Package_Client_02.count import Covert_number



@pytest.mark.usefixtures("init_driver")
@pytest.mark.order_class(2)
class Test_Corrective(unittest.TestCase):
    ...
    @pytest.mark.order(count = count + 1)
